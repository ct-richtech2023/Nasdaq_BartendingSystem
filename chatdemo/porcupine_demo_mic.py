...
from transcribe_streaming_mic import speechtotext
...
class PorcupineDemo(Thread):
    ...
    def run(self):
        ...
        try:
            ...
            print('framlength', porcupine.frame_length)
            recorder.start()
            ...
            while True:
                ...
                if result >= 0:
                    ...
                    print("gttss")
                    gtts.generate_mp3("May I help you?")
                    gtts.play_voice()


                    fun = speechtotext()
                    print("funnnnnnnnnnnnnnnnn!!!!")
                    next(fun)
...
#/s/do0VZfYRk3OPyylYvpDAqa+WIV1WNOpB3GDyDbveF5/srMur4Uw==
def main():
    pass
